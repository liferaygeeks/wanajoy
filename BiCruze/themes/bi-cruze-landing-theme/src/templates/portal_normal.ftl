...
<#include init /> 
<#assign isOmniAdmin = permissionChecker.isOmniadmin() />
<#assign adminclass = "" /> 
...
<body class="${css_class} tm-gray-bg">
...
<#if isOmniAdmin>
 <#assign adminclass = "tm-header-wrapper" /> 
</#if>
...
<div id="content">
		...
		<#--	<#include "${full_templates_path}/navigation.ftl" /> -->
			...
			<header>	
					<div class="tm-header ${adminclass}">
				  		<div class="container">
						  			<div class="row">
							  				<div class="col-lg-6 col-md-4 col-sm-3 tm-site-name-container">
							  					<a href="#" class="tm-site-name" title="<@liferay.language_format arguments="${site_name}" key="go-to-x" />">
							  							<#if show_site_name>
								  			...
								  			<div class="col-lg-6 col-md-8 col-sm-9">
								  				...
								  				<nav class="tm-nav">
													...
													<#list nav_items as nav_item>
																...
																<#assign nav_item_selected = "" />
					
																<#if nav_item.isSelected()>
																	<#assign nav_item_selected = "active" />
																</#if>
														<li><a href="${nav_item.getURL()}" class="${nav_item_selected}" >${nav_item.getName()}</a></li>
		...
		<div class="flexslider flexslider-banner">
		  <ul class="slides">
		    <li>
				...
				<img src="${images_folder}/holiday/banner-1.jpg" alt="Image" />	
		    </li>
		    <li>
			    <div class="tm-banner-inner">
		      ...
		      <img src="${images_folder}/holiday/banner-2.jpg" alt="Image" />
		    </li>
		    <li>
			    <div class="tm-banner-inner">
		      ...
		      <img src="${images_folder}/holiday/banner-3.jpg" alt="Image" />
		    </li>
		  </ul>
		</div>	
	</section>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-center">
					<img src="${images_folder}/holiday/index-01.jpg" alt="image" class="img-responsive">
					<a href="#">
			...
			<div class="col-lg-4 col-md-4 col-sm-6">
				<div class="tm-home-box-1 tm-home-box-1-2 tm-home-box-1-right">
					<img src="${images_folder}/holiday/index-02.jpg" alt="image" class="img-responsive">
					<a href="#">
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2">						
						<img src="${images_folder}/holiday/index-03.jpg" alt="image" class="img-responsive">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2">						
					    <img src="${images_folder}/holiday/index-04.jpg" alt="image" class="img-responsive">
						<h3>Proin Gravida Nibhvel Lorem Quis Bind</h3>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2">						
					    <img src="${images_folder}/holiday/index-05.jpg" alt="image" class="img-responsive">
						<h3>Proin Gravida Nibhvel Lorem Quis Bind</h3>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2 tm-home-box-2-right">						
					    <img src="${images_folder}/holiday/index-06.jpg" alt="image" class="img-responsive">
						<h3>Proin Gravida Nibhvel Lorem Quis Bind</h3>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="tm-home-box-3">
						<div class="tm-home-box-3-img-container">
							<img src="${images_folder}/holiday/index-07.jpg" alt="image" class="img-responsive">	
						</div>						
			     ...
			     <div class="col-lg-6">
			        <div class="tm-home-box-3">
						<div class="tm-home-box-3-img-container">
							<img src="${images_folder}/holiday/index-08.jpg" alt="image" class="img-responsive">	
						</div>						
						<div class="tm-home-box-3-info">
							<p class="tm-home-box-3-description">Proin gravida nibhvell velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum</p>
					        <div class="tm-home-box-2-container">
				...
				<div class="col-lg-6">
				    <div class="tm-home-box-3">
						<div class="tm-home-box-3-img-container">
							<img src="${images_folder}/holiday/index-09.jpg" alt="image" class="img-responsive">	
						</div>						
						<div class="tm-home-box-3-info">
							<p class="tm-home-box-3-description">Proin gravida nibhvell velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum</p>
					        <div class="tm-home-box-2-container">
			    ...
			    <div class="col-lg-6">
			        <div class="tm-home-box-3">
						<div class="tm-home-box-3-img-container">
							<img src="${images_folder}/holiday/index-10.jpg" alt="image" class="img-responsive">	
						</div>						
						<div class="tm-home-box-3-info">
							<p class="tm-home-box-3-description">Proin gravida nibhvell velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum</p>
					        <div class="tm-home-box-2-container">
...
<!-- endinject -->
	...
	<script type="text/javascript" src="${javascript_folder}/bootstrap-datetimepicker.min.js"></script>	
	<script type="text/javascript" src="${javascript_folder}/jquery.flexslider-min.js"></script>
<!--
	<script src="js/froogaloop.js"></script>
	<script src="js/jquery.fitvid.js"></script>
-->
   	<script type="text/javascript" src="${javascript_folder}/templatemo-script.js"></script>      	
	<script>
